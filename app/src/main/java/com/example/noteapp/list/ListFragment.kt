package com.example.noteapp.list
...
import com.example.noteapp.list.adapter.ListAdapter
    ...
    private fun confirmRemoveAll() {
        AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("Yes") { _, _ ->
                ...
                Toast.makeText(requireContext(), "Successfully Remove All", Toast.LENGTH_SHORT)
                    .show()
            }
